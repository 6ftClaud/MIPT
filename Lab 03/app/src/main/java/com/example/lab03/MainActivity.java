...
public class MainActivity extends AppCompatActivity {
    ...
    TextView edt1;
    boolean Addition, Subtract, Multiplication, Division, mSqrt, decimal;
    Button button0, button1, button2, button3, button4, button5, button6, button7, button8, button9, buttonAdd, buttonSub,
            buttonMul, buttonDivision, buttonEqual, buttonDel, buttonDot, sqrt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonSub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (edt1.getText().length() != 0) {
                    input1 = Double.parseDouble(edt1.getText() + "");
                    Subtract = true;
                    decimal = false;
                    edt1.setText(null);
                }
